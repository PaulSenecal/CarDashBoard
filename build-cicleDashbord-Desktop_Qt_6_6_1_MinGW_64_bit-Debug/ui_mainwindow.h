...
public:
    ...
    QLabel *averageConsumptionLabel;
    QLabel *fullCapacityLabel;
    QLabel *averageDistanceRemaininglabel;
    QLabel *energyconsumptionLabel;
...
"color: white;"));
        ...
        averageConsumptionLabel = new QLabel(EnergyComsuptionQgroupBox);
        averageConsumptionLabel->setObjectName("averageConsumptionLabel");
        averageConsumptionLabel->setGeometry(QRect(110, 110, 61, 31));
        averageConsumptionLabel->setStyleSheet(QString::fromUtf8("color :white"));
        fullCapacityLabel = new QLabel(EnergyComsuptionQgroupBox);
        fullCapacityLabel->setObjectName("fullCapacityLabel");
        fullCapacityLabel->setGeometry(QRect(200, 110, 71, 31));
        fullCapacityLabel->setStyleSheet(QString::fromUtf8("color :white"));
        averageDistanceRemaininglabel = new QLabel(EnergyComsuptionQgroupBox);
        averageDistanceRemaininglabel->setObjectName("averageDistanceRemaininglabel");
        averageDistanceRemaininglabel->setGeometry(QRect(20, 110, 61, 31));
        averageDistanceRemaininglabel->setStyleSheet(QString::fromUtf8("color :white"));
        energyconsumptionLabel = new QLabel(EnergyComsuptionQgroupBox);
        energyconsumptionLabel->setObjectName("energyconsumptionLabel");
        energyconsumptionLabel->setGeometry(QRect(20, 30, 281, 31));
        QFont font5;
        font5.setFamilies({QString::fromUtf8("Zero Hour")});
        font5.setPointSize(12);
        energyconsumptionLabel->setFont(font5);
        energyconsumptionLabel->setStyleSheet(QString::fromUtf8("color : white"));
        ...
        batteryGroupBox = new QGroupBox(centralwidget);
        batteryGroupBox->setObjectName("batteryGroupBox");
        batteryGroupBox->setGeometry(QRect(150, 650, 451, 41));
        batteryGroupBox->setStyleSheet(QString::fromUtf8("border :transparant"));
        batteryStatusLabel = new QLabel(batteryGroupBox);
        ...
        labebatteryCapacityQlabel4 = new QLabel(batteryGroupBox);
        ...
        labebatteryCapacityQlabel3 = new QLabel(batteryGroupBox);
        ...
        labebatteryCapacityQlabel2 = new QLabel(batteryGroupBox);
        ...
        batteryLabel = new QLabel(batteryGroupBox);
        ...
        labebatteryCapacityQlabel1 = new QLabel(batteryGroupBox);
        ...
        mainMenuGroupBox->setObjectName("mainMenuGroupBox");
        mainMenuGroupBox->setGeometry(QRect(600, 309, 431, 71));
        mainMenuGroupBox->setStyleSheet(QString::fromUtf8("background: transparent;\n"
"border: transparent;"));
        settingQpushButton = new QPushButton(mainMenuGroupBox);
        settingQpushButton->setObjectName("settingQpushButton");
        settingQpushButton->setGeometry(QRect(370, 30, 41, 41));
        settingQpushButton->setStyleSheet(QString::fromUtf8("background: transparent;\n"
"border: transparent;"));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/Menu/rsc/Menu/setting.png"), QSize(), QIcon::Normal, QIcon::Off);
        settingQpushButton->setIcon(icon);
        settingQpushButton->setIconSize(QSize(41, 41));
        phoneQpushButton = new QPushButton(mainMenuGroupBox);
        phoneQpushButton->setObjectName("phoneQpushButton");
        phoneQpushButton->setGeometry(QRect(290, 30, 41, 41));
        phoneQpushButton->setStyleSheet(QString::fromUtf8("background: transparent;\n"
"border: transparent;"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/Menu/rsc/Menu/phone.png"), QSize(), QIcon::Normal, QIcon::Off);
        phoneQpushButton->setIcon(icon1);
        phoneQpushButton->setIconSize(QSize(31, 41));
        homeQpushButton = new QPushButton(mainMenuGroupBox);
        homeQpushButton->setObjectName("homeQpushButton");
        homeQpushButton->setGeometry(QRect(10, 20, 51, 51));
        homeQpushButton->setStyleSheet(QString::fromUtf8("background: transparent;\n"
"border: transparent;"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/Menu/rsc/Menu/yellowHome.png"), QSize(), QIcon::Normal, QIcon::Off);
        homeQpushButton->setIcon(icon2);
        homeQpushButton->setIconSize(QSize(61, 51));
        musicQpushButton = new QPushButton(mainMenuGroupBox);
        musicQpushButton->setObjectName("musicQpushButton");
        musicQpushButton->setGeometry(QRect(200, 30, 31, 31));
        musicQpushButton->setStyleSheet(QString::fromUtf8("background: transparent;\n"
"border: transparent;"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/Menu/rsc/Menu/music.png"), QSize(), QIcon::Normal, QIcon::Off);
        musicQpushButton->setIcon(icon3);
        musicQpushButton->setIconSize(QSize(31, 31));
        menuQpushButton = new QPushButton(mainMenuGroupBox);
        menuQpushButton->setObjectName("menuQpushButton");
        menuQpushButton->setGeometry(QRect(110, 30, 31, 31));
        menuQpushButton->setStyleSheet(QString::fromUtf8("background: transparent;\n"
"border: transparent;"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/Menu/rsc/Menu/Squarre.png"), QSize(), QIcon::Normal, QIcon::Off);
        menuQpushButton->setIcon(icon4);
        ...
        batteryGroupBox->raise();
        mainMenuGroupBox->raise();
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        averageConsumptionLabel->setText(QCoreApplication::translate("MainWindow", "188 wh/km \n"
"Average", nullptr));
        fullCapacityLabel->setText(QCoreApplication::translate("MainWindow", "27.5 kwh\n"
"FullCapacity", nullptr));
        averageDistanceRemaininglabel->setText(QCoreApplication::translate("MainWindow", "150 km \n"
"Remaining", nullptr));
        energyconsumptionLabel->setText(QCoreApplication::translate("MainWindow", "ENERGY COMSUPTION", nullptr));
        ...
        batteryGroupBox->setTitle(QString());
